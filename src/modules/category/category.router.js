...
router.post('/',auth(endPoints.create),fileUpload(fileTypes.image).single('image'),validation(schema.createCategorySchema),asyncHandler(categoriesController.create));
...
router.delete('/:id',auth(endPoints.delete),validation(schema.deleteCategorySchema),asyncHandler(categoriesController.destroy));
